...
CREATE INDEX IF NOT EXISTS idx_stock_auto_order_schedule_due ON stock_auto_participant_order_schedule(symbol, next_run_at, lease_until, priority, user_key);
CREATE INDEX IF NOT EXISTS idx_stock_auto_order_schedule_profile_due ON stock_auto_participant_order_schedule(profile_type, next_run_at, symbol);
