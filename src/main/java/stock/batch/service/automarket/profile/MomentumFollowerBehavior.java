...
public class MomentumFollowerBehavior extends AbstractAutoProfileBehavior {
    ...
    public MomentumFollowerBehavior() {
        super(AutoParticipantProfileType.MOMENTUM_FOLLOWER, new ProfilePolicy(0.25, 0.85, 0.00, 0.20, 0.35, 0.00, 0.15, 0.25, 1.20, 1.25, 0.80, 0.15, 1.00, 0.05, 0.00, 0.10, 0.05, BigDecimal.ZERO, 30));
    }
